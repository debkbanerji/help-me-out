angular.module('distributeServices').component('distributeServices', {
    ...
    controller: ['$scope', '$routeParams', '$route', '$firebaseObject', '$firebaseArray', function distributeServicesController($scope, $routeParams, $route, $firebaseObject, $firebaseArray) {
        var self = this;
        var user = firebase.auth().currentUser;
        self.servicesRef = firebase.database().ref().child("services");
        self.usersRef = firebase.database().ref().child("users");
        self.servicesArray = $firebaseArray(self.servicesRef);
        self.contactInformation = "You can find me at " + user.email;
        ...
        self.fulfilRequest = function (serviceName, request) {
